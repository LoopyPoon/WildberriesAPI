...
import com.example.wildberriesapi.service.statistics.sales.SalesExcelExporter;
import com.example.wildberriesapi.service.statistics.sales.SupplierSalesService;
import com.example.wildberriesapi.service.statistics.sales.SupplySales;
...
public class SupplierSalesController {
    ...
    public static void open(Stage stage) throws IOException {
        FXMLLoader loader = new FXMLLoader(SupplierSalesController.class.getResource("/com/example/wildberriesapi/controller/fxml/SupplierSalesWindow.fxml"));
