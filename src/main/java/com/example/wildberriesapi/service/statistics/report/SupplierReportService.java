...
public class SupplierReportService {
    ...
    private static final String API_URL = "https://statistics-api.wildberries.ru/api/v5/supplier/reportDetailByPeriod";
    ...
    public List<SupplyReport> getReport(LocalDate dateFrom, int limit, LocalDate dateTo, int rrdid) {
//        log.info("Using API_KEY: {}", API_KEY);
        ...
        String params = String.format("?dateFrom=%s&dateTo=%s&limit=%d&rrdid=%d", formattedDateFrom, formattedDateTo, limit, rrdid);
