...
@Slf4j
public class StocksExcelExporter {
    public static void exportToExcel(List<SupplyStocks> supplyStocksList, File file, LocalDate dateFrom) {
        try (Workbook workbook = new HSSFWorkbook()) {
            Sheet sheet = workbook.createSheet("Склад");
